 ...
 */
  ...
  const Splide = /* #__PURE__ */(function () {
  /**
   * Splide constructor.
   *
   ...
   */
     ...
     */
      toIndex: function toIndex (position) {
        ...
        Elements.getSlides(true).forEach(function (Slide) {
          ...
          const distance = abs(_this2.toPosition(slideIndex) - position)
     ...
     */
      offset: function offset (index) {
        const focus = Splide.options.focus
 ...
 */
   ...
   */
    ...
    function resist (position) {
      if (Splide.is(SLIDE)) {
        ...
        const _start = sign * Track.trim(Track.toPosition(0))

        const _end = sign * Track.trim(Track.toPosition(Controller.edgeIndex))
   ...
   */
    ...
    function analyze (e, startInfo) {
      ...
      const _ref2 = touches ? touches[0] : e
      const clientX = _ref2.clientX
      const clientY = _ref2.clientY

      const _ref3 = startInfo.to || {}
      const _ref3$x = _ref3.x
      const fromX = _ref3$x === void 0 ? clientX : _ref3$x
      const _ref3$y = _ref3.y
      const fromY = _ref3$y === void 0 ? clientY : _ref3$y
 ...
 */
   ...
   */
    ...
    function updateDisabled () {
      const _Components$Controlle = Components.Controller
      const prevIndex = _Components$Controlle.prevIndex
      const nextIndex = _Components$Controlle.nextIndex
 ...
 */
   ...
   */
    ...
    function createPagination () {
      ...
      const items = Elements.getSlides(false).filter(function (Slide) {
   ...
   */
    ...
    function initPagination (data, activeItem) {
      ...
      data.items.forEach(function (item) {
        ...
        const controls = item.Slides.map(function (Slide) {
 ...
 */
   ...
   */
    ...
    function getPoint () {
      const item = map.filter(function (item) {
 ...
 */
  ...
  const complete_Splide = /* #__PURE__ */(function (_Core) {
